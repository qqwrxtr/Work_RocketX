...
(function () {
    ...
    const options = {
        ...
        promoCodeEmail: ".promocode-input-email", // promo-code input for email section
        promoCodePhone: ".promocode-input-phone", // promo-code input for phone section
        ...
        promoCodeErrorEmailClass: ".promocode-error-email",
        promoCodeErrorPhoneClass: ".promocode-error-phone",
    ...
    App.prototype = {
        init: function () {
            ...
            this.promoCodeInputEmail = document.querySelector(options.promoCodeEmail);
            this.promoCodeInputPhone = document.querySelector(options.promoCodePhone);
            ...
            this.promoCodeErrorEmail = document.querySelector(options.promoCodeErrorEmailClass);
            this.promoCodeErrorPhone = document.querySelector(options.promoCodeErrorPhoneClass);
            ...
            if (this.promoCodeInputEmail) {
                this.promoCodeInputEmail.addEventListener('change', function (event) {
                    _this.showError({field: 'promoCodeEmail', message: ''});
        ...
        showError: function (error) {
            switch (error.field) {
                ...
                case "phone":
                    ...
                    break;
                case "promoCodeEmail":
                    if (this.promoCodeErrorEmail) this.promoCodeErrorEmail.innerHTML = error.message;
                    break;
                case "promoCodePhone":
                    if (this.promoCodeErrorPhone) this.promoCodeErrorPhone.innerHTML = error.message;
                    break;
            }
        },
        validate: function () {
        ...
        getPromoCodeValue: function (type) {
            let promoCodeValue = '';
            switch (type) {
                case 'email':
                    promoCodeValue = this.promoCodeInputEmail.value;
                    break;
                case 'phone':
                    promoCodeValue = this.promoCodeInputPhone.value;
                    break;
            }

            return promoCodeValue.trim();
        },
        isAvailablePromoCode: function (type) {
            const _this = this;
            let inputErrorField = '';
            switch (type) {
                case 'email':
                    inputErrorField = 'promoCodeEmail';
                    break;
                case 'phone':
                    inputErrorField = 'promoCodePhone';
                    break;
            }

            return new Promise((resolve) => {
                this.ajax({
                    url: this.params.mbHost + '/api/v1/promo-refill/' + _this.getPromoCodeValue(type) + '/check',
                    method: 'get',
                    data: {},
                    ...
                    onDone: function onDone(data) {
                        if (data.includes('error')) {
                            _this.showError({
                                ...
                                message: messages.promoCode.notFound,
                            })
                        ...
                        if (response.status === 404 || !response.available) {
                            _this.showError({
                                field: inputErrorField,
                                message: messages.promoCode.notFound,
                            })
        ...
        fillRegisterData: function () {
            ...
            if (this.regType === 'email') {
                ...
                this.register({
                    ...
                    promoCode: this.promoCodeInputEmail.value,
                })
            }
            ...
            if (this.regType === 'phone') {
                ...
                this.register({
                    ...
                    ofertaAgreement: ofertaAgreement,
                    bonusType: this.bonusType,
                    promoCode: this.promoCodeInputPhone.value,
                })
            }
        },
        submit: function () {
            ...
            if (!this.getPromoCodeValue(this.regType)) {
                return this.fillRegisterData();
            }

            this.isAvailablePromoCode(this.regType)
                .then(function (isAvailable) {
                    if (!isAvailable) {
                        return;
                    }

                    _this.fillRegisterData();
                })
                .catch(function (data) {
                    console.error(data);
                });
        ...
        register: function (fields) {
            ...
            if (this.regType === 'email') {
                ...
                if (fields.promoCode) {
                    data += '&email_registration_form[promo_code]=' + encodeURIComponent(fields.promoCode)
                }
            }
            ...
            if (this.regType === 'phone') {
                ...
                if (fields.promoCode) {
                    data += '&mobile_registration_form[promo_code]=' + encodeURIComponent(fields.promoCode)
                }
            }
